...
## Companion launcher: floating toolbar, NOT scene-controls (v1.7.3)
...
group's config — first the v1.7.1 `activeTool` band-aid, then a v1.7.3
`primary`→`interface` canvas-group change — but neither could work, because the
