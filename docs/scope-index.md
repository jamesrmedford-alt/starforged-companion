...
| Vow/Combat/Bond Stakes & Rewards | [#241](https://github.com/jamesrmedford-alt/starforged-companion/issues/241) | 🔄 IN PROGRESS | Phase 1 shipped: stakes stated up front at Swear a Vow / Enter the Fray / Forge a Bond; combat offered (Enter the Fray vs. way out) with narrator-suggested difficulty + objective + vow link; won linked fight → difficulty-scaled vow milestone + Attempt to Fulfill + deepen-the-bond; narrator active-fight awareness. Phase 2 (planned): AI-proposed concrete rewards + grant-by-form. See `decisions.md` → "Vow ↔ combat ↔ bond stakes & rewards" |
