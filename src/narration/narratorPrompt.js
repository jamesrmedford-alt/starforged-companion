...
export function appendSidecarInstruction(options = {}) {
  ...
  const lines = [
    ...
    '- REQUIRED: the first time your prose introduces or names a character who',
    '  does NOT appear in the ENTITIES IN SCENE cards, emit a newTruth',
    '  anchoring their identity — who they are, their role in this context,',
    '  and their relationship to the player character — e.g.',
    '  { "subject": "Kael Dros", "fact": "dockmaster at Bleakhold Station;',
    '  meeting the PC here for the first time" }. Without this anchor, the',
    '  same character can be written differently each turn.',
